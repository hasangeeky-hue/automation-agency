...
function anthropos_offers() {
	return array(
		array( 'funnel', 'var(--g2)', 'OFFER 01', '€ · Starter', 'Website Redesign',
		...
		array( 'dataflow', 'var(--flow)', 'OFFER 02', '€€ · Core', 'Lead &amp; Follow-up Automation',
			'leads slip away from slow or forgotten follow-up.',
			'The single highest-leverage fix we install: every inquiry gets an automatic reply within sixty seconds, carrying your credentials and proof before a human ever has to type a word. If they go quiet, up to three gentle reminders follow on a schedule you set — then the sequence hands the warm lead back to you. Firms running manual follow-up convert 20–30% of inquiries; this alone typically moves that number toward 40–60%.' ),
		...
		array( 'core', 'var(--cta)', 'OFFER 05', '€€€ · A-to-Z', 'Full Transformation · AI + n8n',
...
<h2>What changes</h2>
<p>Stores running this system typically add €2,000–5,000 a month in recovered cart revenue, lift repeat-purchase rate by 25–40%, and — for multi-channel sellers — cut customer response time by roughly 80% with overselling eliminated entirely. If your business looks more like one of our other segments — <a href="/services/creators-coaches/" rel="noopener">creators</a>, <a href="/services/freelancers-agencies/" rel="noopener">freelancers</a>, or <a href="/services/" rel="noopener">the full list</a> — the same core system adapts. <a href="/faq/" rel="noopener">Read the FAQ</a> for scope and timeline, or book a free consultation and we'll show you exactly what your current cart-abandonment rate is costing you.</p>
HTML,
			'guides'=> array(
