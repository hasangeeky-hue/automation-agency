...
<section id="solve">
	...
	<div class="wrap"><div class="grid-3">
		<div class="glass reveal tilt" style="--hue:var(--flow)"><canvas class="fxcanvas" data-fx="radar" style="--hue:var(--flow)"></canvas><div class="card-b"><span class="lbl">01 · MAP</span><h4>Find the leak</h4><p>We trace where leads, replies and revenue drain out — visibility, trust, or follow-up.</p></div></div>
		<div class="glass reveal tilt" style="--hue:var(--ai)"><canvas class="fxcanvas" data-fx="workflow" style="--hue:var(--ai)"></canvas><div class="card-b"><span class="lbl">02 · DEPLOY</span><h4>Build the agent</h4><p>An AI agent + n8n workflow takes over: replies in seconds, qualifies, routes, follows up.</p></div></div>
		<div class="glass reveal tilt" style="--hue:var(--cta)"><canvas class="fxcanvas" data-fx="growth" style="--hue:var(--cta)"></canvas><div class="card-b"><span class="lbl">03 · COMPOUND</span><h4>Watch it run</h4><p>Connected once, working forever — leads flow to booked calls while it reports what works.</p></div></div>
	</div></div>
</section>
...
<section id="blog">
	...
	<div class="wrap"><div class="grid-3">
		...
		if ( $q->have_posts() ) :
			...
			<a class="glass post reveal tilt" href="<?php echo esc_url( $blog ); ?>" style="--hue:var(--ai)"><canvas class="fxcanvas" data-fx="neural" style="--hue:var(--ai)"></canvas><div class="post-b"><span class="pc">AI Agents</span><h4>What an AI agent actually does in a small business</h4><p>[Fake excerpt] Triggers, tools and memory in plain language.</p><span class="pr">Read →</span></div></a>
			...
			<a class="glass post reveal tilt" href="<?php echo esc_url( $blog ); ?>" style="--hue:var(--g5)"><canvas class="fxcanvas" data-fx="social" style="--hue:var(--g5)"></canvas><div class="post-b"><span class="pc">Social &amp; Marketing</span><h4>Social media automation that doesn't sound like a robot</h4><p>[Fake excerpt] Draft, approve, schedule, repurpose.</p><span class="pr">Read →</span></div></a>
		<?php endif; ?>
