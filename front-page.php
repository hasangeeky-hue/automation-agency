...
<section id="team">
	...
	<div class="wrap"><div class="team" role="list">
		<article class="glass tm reveal" role="listitem" style="--tmhue:var(--ai)"><div class="tm-photo"><img src="https://anthropos-automation.com/wp-content/uploads/2026/07/Hasan.jpg" alt="Murtuja Hasan" loading="lazy"></div><div class="tm-body"><h5>Murtuja Hasan<?php echo anthropos_linkedin( 'https://www.linkedin.com/in/mhasan03', 'Murtuja Hasan' ); ?></h5><span class="tm-role">Co-founder &amp; CEO</span><p>Grows real businesses with the exact automation-and-marketing playbook he'll build for you.</p></div></article>
		<article class="glass tm reveal" role="listitem" style="--tmhue:var(--flow)"><div class="tm-photo"><img src="https://anthropos-automation.com/wp-content/uploads/2026/07/Ahsan.jpeg" alt="Ahasanul Haque" loading="lazy"></div><div class="tm-body"><h5>Ahasanul Haque<?php echo anthropos_linkedin( 'https://www.linkedin.com/in/haque-ahsanul', 'Ahasanul Haque' ); ?></h5><span class="tm-role">Co-founder &amp; CTO</span><p>Builds the AI under the hood and makes sure the clever stuff just works, every time.</p></div></article>
		<article class="glass tm reveal" role="listitem" style="--tmhue:var(--cta)"><div class="tm-photo"><img src="https://anthropos-automation.com/wp-content/uploads/2026/07/sina.jpeg" alt="Sina Khouei" loading="lazy"></div><div class="tm-body"><h5>Sina Khouei<?php echo anthropos_linkedin( 'https://www.linkedin.com/in/sina-khouei-524a04171', 'Sina Khouei' ); ?></h5><span class="tm-role">Cybersecurity &amp; Applied AI</span><p>Keeps your data and your automations locked down, so you never have to think about it.</p></div></article>
		<article class="glass tm reveal" role="listitem" style="--tmhue:var(--g6)"><div class="tm-photo"><img src="https://anthropos-automation.com/wp-content/uploads/2026/07/ariful.jpeg" alt="Ariful Islam" loading="lazy"></div><div class="tm-body"><h5>Ariful Islam<?php echo anthropos_linkedin( 'https://www.linkedin.com/in/aisforarif', 'Ariful Islam' ); ?></h5><span class="tm-role">Media Buying &amp; Ads Automation</span><p>Turns ad budget into booked customers, not wasted clicks.</p></div></article>
