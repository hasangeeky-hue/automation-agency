...
<section id="team">
	...
	<div class="wrap"><div class="team" role="list">
		...
		<article class="glass tm reveal" role="listitem" style="--tmhue:var(--flow)"><div class="tm-photo"><img src="https://anthropos-automation.com/wp-content/uploads/2026/07/Ahsan.jpeg" alt="Ahasanul Haque" loading="lazy"></div><div class="tm-body"><h5>Ahasanul Haque</h5><span class="tm-role">Co-founder &amp; CTO</span><p>Builds the AI under the hood and makes sure the clever stuff just works, every time.</p></div></article>
		<article class="glass tm reveal" role="listitem" style="--tmhue:var(--cta)"><div class="tm-photo"><img src="https://anthropos-automation.com/wp-content/uploads/2026/07/sina.jpeg" alt="Sina Khouei" loading="lazy"></div><div class="tm-body"><h5>Sina Khouei</h5><span class="tm-role">Cybersecurity &amp; Applied AI</span><p>Keeps your data and your automations locked down, so you never have to think about it.</p></div></article>
