...
define( 'ANTHROPOS_VERSION', '5.10.0' );
...
function anthropos_faq_data() {
	return array(
		'general' => array(
			...
			array( "What does it cost to work with you?", "Pricing follows scope rather than a fixed menu, because a single-page website and a full multi-tool build are very different jobs. Every service page shows five offers arranged from € Starter (a focused website redesign) through €€ Core and Growth (lead, marketing or social automation) up to €€€ A-to-Z, the whole connected system. You get one fixed quote after the free consultation — no hourly meter, no surprise invoices, and no upsell pressure. If budget is tight, we will tell you honestly which single change recovers the most revenue first, so you can start small and let it pay for the rest." ),
		...
		'servicesScope' => array(
			array( "What are the five offers, and how do they differ?", "The five offers move from a single fix to the whole system. Website Redesign (€) rebuilds a fast, mobile-first site engineered around the five-second test. Lead &amp; Follow-up Automation (€€) is the highest-leverage layer — instant replies, nurture and win-backs so no enquiry slips away. Marketing Automation (€€) runs seasonal campaigns, newsletters and segmentation on a calendar instead of your memory, and Social Media Automation (€€) drafts, schedules and repurposes on-brand content for your approval. Full Transformation (€€€) wires all of it together on n8n with your inbox, CRM, calendar and invoicing, so you stop being the glue between five separate tools." ),
			array( "Can I combine services, or do I have to buy the whole thing?", "You can combine them freely, and most businesses start with just one. Each service page is really a micro-combo built for a specific type of business, and you can take a single offer, two of them, or the complete A-to-Z system. Because everything sits on the same foundation, adding a layer later never means rebuilding what you already have — the pieces are designed to click together. We help you sequence it so each stage pays for the next, rather than asking for one big outlay up front." ),
		...
		'trustPricing' => array(
			...
			array( "How is pricing structured, and when do I know the number?", "Pricing is by scope, in three broad tiers: € Starter for a focused single fix, €€ Core and Growth for a working automation layer, and €€€ A-to-Z for the whole connected system. You get one fixed quote after the free consultation, once we understand your actual situation — never an hourly meter, and never a number pulled from the air before we have looked properly. If a tier is out of reach, we will tell you which single change recovers the most revenue first, so you can start there. The quote is the quote; any scope change is agreed with you, not billed by surprise." ),
