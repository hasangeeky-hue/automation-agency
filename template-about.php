	...
	<div class="wrap">
		...
		<div class="team" role="list" style="margin-top:16px">
			...
			<article class="glass tm reveal" role="listitem" style="--tmhue:var(--g5)"><div class="tm-photo"><img src="https://anthropos-automation.com/wp-content/uploads/2026/07/Razzyak.jpeg" alt="Abdur Razak" loading="lazy"></div><div class="tm-body"><h5><a href="https://www.razzakabdur.com/" target="_blank" rel="noopener">Abdur Razak</a></h5><span class="tm-role">Head of Web Development</span><p>A full-stack developer who builds the websites and tools your system runs on, and documents his work so you can own and maintain it.</p></div></article>
				<article class="glass tm reveal" role="listitem" style="--tmhue:var(--g4)"><div class="tm-photo"><img src="https://anthropos-automation.com/wp-content/uploads/2026/07/5402135274671775204.jpg" alt="Jurek Bormann" loading="lazy"></div><div class="tm-body"><h5>Jurek Bormann</h5><span class="tm-role">Head of Content</span><p>A writer and SEO specialist who plans and produces our guides, articles and social posts, and tunes each one to rank and convert. Years in fast, high-volume media, now pointed at making automation clear and easy to act on.</p></div></article>
		</div>
	</div>
</section>
<?php
